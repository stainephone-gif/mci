# Flappy Bird - Мультиплатформенная игра

Классическая игра Flappy Bird с нативными реализациями для Android и macOS.

## Доступные версии

- **Android** - Java приложение (см. ниже)
- **macOS** - Swift + SpriteKit приложение (см. [`FlappyBirdMac/README.md`](FlappyBirdMac/README.md))
...
Нативное Android-приложение, реализующее популярную игру Flappy Bird. Управляйте птицей, нажимая на экран, и старайтесь пролететь между зелеными трубами!
